    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-bold text-white" style={{ fontSize: 'calc(1.875rem + 16px)' }}>Health Queue</h1>
          <p className="text-gray-300">서비스 이용 모드 선택</p>
        </div>
        
        <div className="space-y-4">
          <Card className="hover:shadow-lg transition-shadow cursor-pointer border-gray-600 bg-card" 
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">헬스장 기구를 예약하고 이용하세요</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">헬스장을 관리하고 운영하세요</p>
                </div>
              </div>
            </CardContent>
          </Card>
