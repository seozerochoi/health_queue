    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-white" style={{ fontSize: 'calc(1.875rem + 16px)' }}>
            Health Queue
          </h1>
        </div>
...
export default function AuthInitial({
  ...
  onNavigate: (v: "signup" | "login") => void;
}) {
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="space-y-4">
          <button
            onClick={() => onNavigate("signup")}
            className="w-full h-14 bg-white text-black rounded-lg hover:bg-gray-200 transition-colors"
          >
            회원가입 하기
          </button>
