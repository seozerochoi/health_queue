...
export default function App() {
  ...
  const handleSignUpStep2Complete = (name: string, nickname: string, role: 'user' | 'admin') => {
    setUserRole(role);
  ...
  const renderCurrentView = () => {
    switch (currentView) {
      ...
      case 'signup':
        return <SignUp onBack={navigateBack} onSignUpComplete={handleSignUpStep1Complete} />;
